...
const submitBtn = document.querySelector('#submitBtn')
    submitBtn.addEventListener('click', (event) => {
        ...
        if(bookTitle === '' || author === '' || pageNum === '' || releaseDate === ''){
            return
        }
    const newBook = addBookToLibrary(bookTitle, author, pageNum, releaseDate, read)
        bookForm.reset()
...
const book2 = addBookToLibrary("Harry Potter and the Sorcerer's Stone", "J.K. Rowling", 309, 1997, true);
const book3 = addBookToLibrary("The Name of the Wind", "Patrick Rothfuss", 662, 2007, false);

addBookToDOM("The Hobbit", "J.R.R. Tolkien", 310, 1937, true, book1.ID);
addBookToDOM("Harry Potter and the Sorcerer's Stone", "J.K. Rowling", 309, 1997, true, book2.ID);
addBookToDOM("The Name of the Wind", "Patrick Rothfuss", 662, 2007, false, book3.ID);